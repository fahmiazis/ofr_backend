...
module.exports = {
  ...
  getCoa: async (req, res) => {
    try {
      ...
      const listGl = [524112, 55050009, 548519, 63050009, 52010401, 524111]
      const listPma = [524112, 55050009, 548519, 63050009, 52010401, 524111]
  ...
  getAllCoa: async (req, res) => {
    try {
      ...
      if (!limit) {
        ...
        const findLimit = await coa.findAll()

...
route.patch('/update/:id/:idtrans', ikk.editIkk)
...
route.patch('/detailid/:id', ikk.getDetailId)
route.get('/report', ikk.getReport)
route.post('/uplist', ikk.uploadBukti)
route.patch('/sublistbayar', ikk.submitBuktiBayar)
route.patch('/upniverif', ikk.updateNilaiVerif)
